...
const IdiomaPromo = ({ data, parcel, campaign }) => {
            ...
            <div>
                ...
                <p>
                    O valor total da carga horária contratada é de R$ {
                        ...
                        data["Data de vencimento da primeira parcela"].split("/")[0]
                    }  de cada mês, sendo o vencimento
                    da primeira parcela na data  {
                        data["Data de vencimento da primeira parcela"]
                    } e, a última, no dia  {
                        data["Data de vencimento da última parcela"]
                    } .
                </p>
                <p>
                    ...
                    cada parcela será de R${parseFloat(parcel[parcel.length - 1]?.valor) + parseInt(data["Valor do desconto de pontualidade por parcela"])
...
export default IdiomaPromo


IdiomaPromo.propTypes = {
