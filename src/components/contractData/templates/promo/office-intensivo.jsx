...
const OfficeIntensivo = ({ data, parcel, campaign }) => {
    ...
    return (
        <Container id="content">
            <div>
                ...
                <table>
                    <tr><h5>Nome: {data["Nome do responsável"]}</h5></tr>
                    <tr>
                        <td><h5>RG: {data["RG responsável"]}</h5></td>
                        <td><h5>E-mail: {data.email}</h5></td>
                    </tr>
                    <tr>
                        <td><h5>Data de Nascimento: {data["Data de nascimento do  responsável"]}</h5></td>
                    ...
                    <tr>
                        <td><h5>Profissão: {data["Profissão"]}</h5></td>
