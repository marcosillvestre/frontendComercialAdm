...
const ExcelPromo = ({ data, parcel, campaign }) => {
        ...
        <Container id="content">
            <div>
                ...
                <p>
                    ...
                    no dia {data["Data da primeira aula"]}, sujeito à alteração mediante aviso
                    prévio.
                </p>
                <br />
                <hr />
                ...
                <p>
                    ...
                    da primeira parcela na data {
                        data["Data de vencimento da primeira parcela"]
                ...
                <p>
                    <br />4.1: A CONTRATADA se obriga à prestação de serviço
                    ...
                    <br />4.2: Após a conclusão da carga horária e aprovação de cada
                    ...
                    ser custeados pelo solicitante. <br />4.2.1: Para que o
                ...
                <p>
                    <br />6.1 Haverá um prazo de tolerância de atraso de até 15
                    ...
                    <br />6.1.1 O CONTRATANTE terá o direito a 10 (dez) reposições
                    ...
                    horas de antecedência. <br />6.1.2: A remarcação da aula de
                    reposição cancelada seguindo os critérios mencionados na
                    cláusula <br />6.1.1 observará os horários disponíveis da
                ...
                <p>
                    <br />10.1 É de responsabilidade do CONTRATANTE adquirir e por
                    vezes disponibilizado para compra o material didático
                    sugerido pela CONTRATADA para que o aluno acompanhe as
                    aulas. <br />10.2: O material pode ser adquirido através de uma
                    ...
                    responsabilização civil e criminal. <br />10.3 Na condição do
                    ...
                    crédito. <br />10.3.1 O material didático será entregue à
