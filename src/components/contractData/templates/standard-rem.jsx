        ...
        <Container id="content">
            <div>
                ...
                <p>
                    ...
                    parcelas cada qual com o vencimento para o dia {data.diaVenvimento.split("/")[0]}
                    de cada mês, sendo o vencimento da primeira parcela na data {data.dataPrimeiraParcelaMensalidade}
                ...
                <p>
                    ...
                    máximo de 10(dez) alunos para dar início às aulas. 3.3: Caso
                ...
                <p>
                    ...
                    antecedência. 6.1.2: A remarcação da aula de reposição
                ...
                <p>
                    9.1: É de entendimento mútuo entre as partes que o término do CONTRATO será efetuado, de fato, na INEXISTÊNCIA de débitos EM ABERTO por parte do CONTRATANTE, mediante o RECIBO DE QUITAÇÃO. Sendo assim, a) vencimento do prazo contratual, b) cumprimento de carga horária e/ou c) abandono de curso não são critérios válidos para o término de contrato, por si só.
                    9.2: A titularidade deste contrato é intransferível e insubstituível, e só poderá ser feita, como caso de EXCEÇÃO, em comum acordo entre as partes, devidamente assinado por ambos, através de um aditamento a este.
                    9.3: No tocante ao exercício do direito de desistência antes do início das aulas o mesmo terá apresente regulamentação:
                    9.3.1: Em caso de assinatura deste contrato de forma online para a realização de aulas presenciais, online ou híbridas o prazo para desistência é de 7 dias contados do ato da assinatura digital.
                    9.3.2: Em caso de assinatura presencial na sede da contratada seja para a modalidade presencial, online ou híbrida o prazo de desistência é de 48 (quarenta e oito) horas antes do início das aulas.
                    9.3.3: Em caso de desistência após os prazos estipulados acima, não haverá devolução de valores de pagamentos já efetuados.
                    9.4: O pedido de cancelamento/desistência/rescisão da matrícula deverá ser formalizado por escrito durante reunião presencial em uma das unidades com a Coordenação Pedagógica, a ser marcada pelo CONTRATANTE com antecedência mínima de 30 (trinta) dias, contados a partir do vencimento da última parcela paga, observadas as disposições legais. Em caso de aluno que faça o curso exclusivamente online, a reunião poderá ser realizada via videochamada.
                    9.5: O pedido de cancelamento/desistência/rescisão da matrícula deverá ser formalizado por escrito durante reunião presencial em uma das unidades com a Coordenação Pedagógica, a ser marcada pelo CONTRATANTE com antecedência mínima de 30 (trinta) dias da data de vencimento da parcela referente ao mês de saída do curso. Em caso de aluno que faça o curso exclusivamente online, a reunião poderá ser realizada via videochamada.
                    9.6: Caso o aviso de cancelamento ocorra antes do prazo de 30 dias citados na cláusula anterior, serão devidos pelo CONTRATANTE a parcela referente ao mês de saída do aluno.
                    9.7: A ausência do aviso de cancelamento/desistência/rescisão obrigará o CONTRATANTE ao pagamento de 01 parcela correspondente ao período de 30 dias da comunicação que deveria ter sido efetuada ao CONTRATANTE.
                    9.8: Em se tratando de abandono das aulas da carga horária contratada, a CONTRATADA é autorizada a tomar quaisquer medidas cabíveis para recebimento dos devidos valores acrescidos de juros e correção monetária, e, medidas judiciais em prol do recebimento de eventuais valores. Os honorários e despesas processuais ficarão sob a responsabilidade do CONTRATANTE.
                    9.9: A CONTRATADA pode de imediato, rescindir o presente instrumento, independente de aviso ou notificação, em caso de descumprimento de qualquer dos itens expostos neste contrato, por parte do CONTRATANTE, ou por indisciplina do mesmo.
                    9.10: O não pagamento da mensalidade no vencimento dará permissão à CONTRATADA impedir a renovação da matrícula para o módulo seguinte, não isentando o CONTRATANTE da obrigação de quitação dos débitos existentes.
                    9.11: O contrato se consumará após a conclusão de todas as aulas contratadas e a confirmação de quitação de quaisquer débitos pendentes pelas partes envolvidas.
                </p>
