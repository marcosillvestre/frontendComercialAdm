...
export const PDFFile = ({ data, choosedData, campaign }) => {
    ...
    const { service, products, tax } = choosedData;
                        ...
                        >
                            ...
                            >
                                ...
                                <p>
                                    ...
                                    A CONTRATADA poderá conceder um desconto condicional de R${(tax?.descount ?? '0,00')} <strong>somados aos demais descontos</strong>,

                                    resultando em um valor líquido final a ser pago de R${(tax?.price ?? '350,00')}, desde que atendidas as condições estabelecidas no contrato,
...
PDFFile.propTypes = {
    ...
    data: PropTypes.shape({
        ...
        newTax: PropTypes.arrayOf({
            materials: PropTypes.array,
            total: PropTypes.string,
            descount: PropTypes.string,

        }),
        newService: PropTypes.arrayOf({
    ...
    choosedData: PropTypes.shape({
        tax: PropTypes.shape({
            sellected: PropTypes.array,
            fullPrice: PropTypes.number,
            descount: PropTypes.number,
