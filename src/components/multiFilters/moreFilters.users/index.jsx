...
import { CustomDateMenuUsers } from '../../customDateMenu/filteringMenu.Users/index.jsx';

export function UsersMoreFilters({ disabled }) {

    const { anchorEl, handleClose, setAnchorEl } = useUser();
    const { filterInitialDate, filterEndDate, setTypeFilter, typeFilter } = useUsers();

    const { roles } = businessRules;
