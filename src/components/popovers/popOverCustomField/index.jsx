...
export function PopOverCustomFields(data) {
    ...
    const { setEditCustomField, deleteCustomField } = useCustomFields()
    ...
    const reset = () => {
        deleteCustomField.mutateAsync(row.id)
    }
