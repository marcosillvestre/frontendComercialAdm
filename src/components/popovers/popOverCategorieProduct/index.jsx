...
export function PopOverCategorieProduct(data) {
    ...
    const { setEditCategorieProducts, deleteCategorieProducts, setCategorieProducts } = useCategorieProducts();
    ...
    const handleEdit = (action) => {
        ...
        action ? setEditCategorieProducts({ id, name, ...rest }) :
            setCategorieProducts({ ...rest })

        handleClick();
    }

    const reset = () => {
        deleteCategorieProducts.mutateAsync(row.id)
    }
...
PopOverCategorieProduct.propTypes = {
    row: PropTypes.shape({
