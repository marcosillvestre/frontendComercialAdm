...
import { DatePickerHistoricOrders } from '../../datePickers/datePicker.HistoricOrders/index.jsx';


export function CustomDateMenuHistoricOrders({ props, fn, where }) {
                    ...
                    date ?
                        <RangeDate>
                            ...
                            <span className='span-container'>
                                <DatePickerHistoricOrders text="Data inicial" where={where} />
                                <p>até</p>
                                <DatePickerHistoricOrders text="Data final" where={where} />
                            </span>
                            <hr />
                            <button
...
CustomDateMenuHistoricOrders.propTypes = {
